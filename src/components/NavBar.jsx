    ...
    <nav className="navbar navbar-expand-lg navbar-dark navbar-gradient fixed-top">
      <Container fluid>
        ...
        <div className="d-flex align-items-center gap-5 me-5">
          <NavDropdown className="text-black d-flex flex-row align-items-center" title={<PersonCircle size={24} color="black" />} id="navbarScrollingDropdown">
            <NavDropdown.Item href="#">Accedi</NavDropdown.Item>
            <NavDropdown.Item href="#">Registrati</NavDropdown.Item>
          </NavDropdown>
          <NavDropdown className="text-black d-flex flex-row align-items-center" title={<BagHeart size={24} color="black" />} id="navbarScrollingDropdown">
